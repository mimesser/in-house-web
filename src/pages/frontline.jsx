...
const HeaderImageBgCss = css`
  background: linear-gradient(180.68deg, rgba(17, 17, 17, 0.15) 31.47%, #111111 99.41%),
    url('https://in-house.azureedge.net/webstatic/landing_main/frontline-hero-375.jpg') no-repeat;  
  ...
  @media ${device.iPhone8Plus} {
    background: linear-gradient(180.68deg, rgba(17, 17, 17, 0.15) 31.47%, #111111 99.41%),
      url('https://in-house.azureedge.net/webstatic/landing_main/frontline-hero-414.jpg') no-repeat;
  }
  @media ${device.iPad} {
    background: linear-gradient(180.68deg, rgba(17, 17, 17, 0.15) 31.47%, #111111 99.41%),
      url(https://in-house.azureedge.net/webstatic/landing_main/frontline-hero-768.jpg) no-repeat;
  }
  @media ${device.web} {
    background: linear-gradient(180.68deg, rgba(17, 17, 17, 0.15) 31.47%, #111111 99.41%),
      url(https://in-house.azureedge.net/webstatic/landing_main/frontline-hero-1280.jpg) no-repeat;
  }
  @media ${device.laptop} {
    background: linear-gradient(180.68deg, rgba(17, 17, 17, 0.15) 31.47%, #111111 99.41%),
      url(https://in-house.azureedge.net/webstatic/landing_main/frontline-hero-1366.jpg) no-repeat;
  }
  @media ${device.desktop} {
    background: linear-gradient(180.68deg, rgba(17, 17, 17, 0.15) 31.47%, #111111 99.41%),
      url(https://in-house.azureedge.net/webstatic/landing_main/frontline-hero-1920.jpg) no-repeat;
  }
...
const BottomImageBgCss = css`
  ...
  background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-375.jpg');

  @media ${device.iPhoneX} {
    background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-375.jpg');
  }
  @media ${device.iPhone8Plus} {
    background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-414.jpg');
  }
  @media ${device.iPad} {
    background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-768.jpg');
  }
  @media ${device.web} {
    background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-1280.jpg');
  }
  @media ${device.laptop} {
    background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-1366.jpg');
  }
  @media ${device.desktop} {
    background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-1920.jpg');
  }
  @media ${device.macbook} {
    background-image: url('https://in-house.azureedge.net/webstatic/landing_main/frontline-product-1920.jpg');
  }
