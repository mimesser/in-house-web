    ...
    <Layout>
      <Results>
        <PageHeader>
          ...
          <Break />
          <>
            during the current state of the world, we have created this space to allow essential
            workers to connect and share their realities on the ground so that thei leadership can
            hear them
          </>
        </PageHeader>
